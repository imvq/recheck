...
const HeadChapter = (
  <>
    <styled.TitleWrapped>Privacy Policy</styled.TitleWrapped>
...
const InterpretationsChapter = (
  <>
    <styled.SubTitleWrapped>Interpretation</styled.SubTitleWrapped>
...
const DefinitionsChapter = (
  <>
    <styled.SubTitleWrapped>Definitions</styled.SubTitleWrapped>
    ...
    <styled.TextWrapped>
      ...
      services related to the Service or to assist the Company in analyzing how the Service
      is used.
    </styled.TextWrapped>
    ...
    <styled.TextWrapped>
      Website refers to reCheck, accessible from https://recheck-candidate.com
    </styled.TextWrapped>
...
const InterpretationsAndDefinitionsChapter = (
  <>
    <styled.TitleWrapped>Interpretation and Definitions</styled.TitleWrapped>
    {InterpretationsChapter}
    {DefinitionsChapter}
  </>
);

const PersonalDataTypeChapter = (
  <>
    <styled.BlockTitleWrapped>Personal Data</styled.BlockTitleWrapped>

    <styled.TextWrapped>
      While using Our Service, We may ask You to provide Us with certainpersonallyidentifiable
      information that can be used to contact or identify You. Personally identifiable
      information may include, but is not limited to:
    </styled.TextWrapped>

    <styled.TextWrapped>1. Email address</styled.TextWrapped>
    <styled.TextWrapped>2. First name and last name</styled.TextWrapped>
    <styled.TextWrapped>3. Usage Data</styled.TextWrapped>
  </>
);

const UsageDataTypeChapter = (
  <>
    <styled.BlockTitleWrapped>Usage Data</styled.BlockTitleWrapped>
...
const ThirdPartyTypeChapter = (
  <>
    <styled.BlockTitleWrapped>
    ...
    <styled.TextWrapped>1. LinkedIn</styled.TextWrapped>
    <styled.TextWrapped>2. Google</styled.TextWrapped>
...
const TrackingTypeChapter = (
  <>
    <styled.BlockTitleWrapped>Tracking Technologies and Cookies</styled.BlockTitleWrapped>
    ...
    <styled.TextWrapped>
      1. Cookies or Browser Cookies. A cookie is a small file placed on Your Device. You can
    ...
    <styled.TextWrapped>
      2. Web Beacons. Certain sections of our Service and our emails may contain small electronic
    ...
    <styled.TextWrapped>1. Necessary / Essential Cookies</styled.TextWrapped>
    <styled.TextWrapped>Type: Session Cookies</styled.TextWrapped>
    <styled.TextWrapped>Administered by: Us</styled.TextWrapped>
    <styled.TextWrapped>
    ...
    <styled.TextWrapped>2. Cookies Policy / Notice Acceptance Cookies</styled.TextWrapped>
    <styled.TextWrapped>Type: Session Cookies</styled.TextWrapped>
    <styled.TextWrapped>Administered by: Us</styled.TextWrapped>
    <styled.TextWrapped>
    ...
    <styled.TextWrapped>3. Functionality Cookies</styled.TextWrapped>
    <styled.TextWrapped>Type: Session Cookies</styled.TextWrapped>
    <styled.TextWrapped>Administered by: Us</styled.TextWrapped>
    <styled.TextWrapped>
...
const TypesOfDataCollectedChapter = (
  <>
    <styled.SubTitleWrapped>Types of Data Collected</styled.SubTitleWrapped>
    {PersonalDataTypeChapter}
    {UsageDataTypeChapter}
    {ThirdPartyTypeChapter}
    {TrackingTypeChapter}
  </>
);

const UseOfPersonalDataChapter = (
  <>
    <styled.SubTitleWrapped>Use of Your Personal Data</styled.SubTitleWrapped>
    ...
    <styled.TextWrapped>
      2. To manage Your Account: to manage Your registration as a user of the Service. The
      Personal Data You provide can give You access to different functionalities of the Service
      that are available to You as a registered user.
    </styled.TextWrapped>

    <styled.TextWrapped>
      3. For the performance of a contract: the development, compliance and undertaking of the
      purchase contract for the products, items or services You have purchased or of any other
      contract with Us through the Service.
    </styled.TextWrapped>

    <styled.TextWrapped>
      4. To contact You: To contact You by email, telephone calls, SMS, or other equivalent
    ...
    <styled.TextWrapped>
      5. To provide You with news, special offers and general information about other goods,
    ...
    <styled.TextWrapped>
      7. For business transfers: We may use Your information to evaluate or conduct a merger,
    ...
    <styled.TextWrapped>
      8. For other purposes: We may use Your information for other purposes, such as data analysis,
    ...
    <styled.TextWrapped>
      1. With Service Providers: We may share Your personal information with Service Providers to
      monitor and analyze the use of our Service, to contact You.
    </styled.TextWrapped>

    <styled.TextWrapped>
      2. For business transfers: We may share or transfer Your personal information in connection
      with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition
      of all or a portion of Our business to another company.
    </styled.TextWrapped>

    <styled.TextWrapped>
      3. With Affiliates: We may share Your information with Our affiliates, in which case we will
    ...
    <styled.TextWrapped>
      4. With business partners: We may share Your information with Our business partners to offer
    ...
    <styled.TextWrapped>
      6. With Your consent: We may disclose Your personal information for any other purpose with
      Your consent.
    </styled.TextWrapped>
  </>
);

const PersonalDataRetentionChapter = (
  <>
    <styled.SubTitleWrapped>Use of Your Personal Data</styled.SubTitleWrapped>
...
const PersonalDataTransferChapter = (
  <>
    <styled.SubTitleWrapped>Transfer of Your Personal Data</styled.SubTitleWrapped>
...
const BusinessTransactionsDisclosureChapter = (
  <>
    <styled.BlockTitleWrapped>Business Transactions</styled.BlockTitleWrapped>
...
const LawEnforcementDisclosureChapter = (
  <>
    <styled.BlockTitleWrapped>Law enforcement</styled.BlockTitleWrapped>
...
const OtherLegalRequirementsDisclosureChapter = (
  <>
    <styled.BlockTitleWrapped>Other legal requirements</styled.BlockTitleWrapped>
...
const PersonalDataDisclosureChapter = (
  <>
    <styled.SubTitleWrapped>Disclosure of Your Personal Data</styled.SubTitleWrapped>

    {BusinessTransactionsDisclosureChapter}
    {LawEnforcementDisclosureChapter}
    {OtherLegalRequirementsDisclosureChapter}
  </>
);

const PersonalDataSecurityChapter = (
  <>
    <styled.SubTitleWrapped>Security of Your Personal Data</styled.SubTitleWrapped>
...
const PersonalDataChapter = (
  <>
    <styled.TitleWrapped>Collecting and Using Your Personal Data</styled.TitleWrapped>

    {TypesOfDataCollectedChapter}
    {UseOfPersonalDataChapter}
    {PersonalDataRetentionChapter}
    {PersonalDataTransferChapter}
    {PersonalDataDisclosureChapter}
    {PersonalDataSecurityChapter}
  </>
);

const ChildrensPrivacyChapter = (
  <>
    <styled.TitleWrapped>Children&apos;s Privacy</styled.TitleWrapped>
...
const ExternalLinksChapter = (
  <>
    <styled.TitleWrapped>Links to Other Websites</styled.TitleWrapped>
...
const ChangesChapter = (
  <>
    <styled.TitleWrapped>Changes to this Privacy Policy</styled.TitleWrapped>
...
const ContactChapter = (
  <>
    <styled.TitleWrapped>Contact Us</styled.TitleWrapped>

    <styled.TextWrapped>
      If you have any questions about this Privacy Policy, You can contact us:
      info@recheck-candidate.com
    </styled.TextWrapped>
  </>
);
...
const Content = (
  <styled.Content>
    {HeadChapter}
    {InterpretationsAndDefinitionsChapter}
    {PersonalDataChapter}
    {ChildrensPrivacyChapter}
