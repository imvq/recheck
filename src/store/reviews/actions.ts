...
export const setObservedReviewsAmount = (amount: number): types.IAction => ({
  type: types.SET_OBSERVED_REVIEWS_AMOUNT,
  payload: amount
});
...
export const setCurrentObservedReview = (review: IReviewReceived): types.IAction => ({
  type: types.SET_CURRENT_OBSERVED_REVIEW,
  payload: review
});
