...
exports.up = database => (
  executeMigration(database, '20210915193006-Name-token-entity-provided-up.sql')
);

exports.down = database => (
  executeMigration(database, '20210915193006-Name-token-entity-provided-down.sql')
);
