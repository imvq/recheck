...
exports.up = database => (
  executeMigration(database, '20211113113757-Users-availability-table-provided-up.sql')
);

exports.down = database => (
  executeMigration(database, '20211113113757-Users-availability-table-provided-down.sql')
);
