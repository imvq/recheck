...
exports.up = database => (
  executeMigration(database, '20210916213422-User-confirmation-provided-up.sql')
);

exports.down = database => (
  executeMigration(database, '20210916213422-User-confirmation-provided-down.sql')
);
